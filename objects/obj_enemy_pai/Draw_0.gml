...
//if is_buffed {image_xscale = 2; image_yscale = 2}
...
{
	//me virando para o player
	if obj_player.x < x and !is_buffed { image_xscale = -1 }
	else if obj_player.x > x and !is_buffed { image_xscale = 1 }
	else if obj_player.x < x and is_buffed { image_xscale = -2; image_yscale = 2 }
	else if obj_player.x > x and is_buffed { image_xscale = 2; image_yscale = 2 }
}